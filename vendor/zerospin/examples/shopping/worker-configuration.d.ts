/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=./wrangler.jsonc` (hash: 2bd55d2a0987007bb1937d1da88d3b71)
// Runtime types generated with workerd@1.20260730.1 2026-01-20 nodejs_compat
interface __BaseEnv_Env {
	...
	AGGREGATE_REPO: DurableObjectNamespace<import("./src/Worker").AggregateRepo>;
	SERVICE_REPO: DurableObjectNamespace<import("./src/Worker").ServiceRepo>;
	AGGREGATE_BLOCK_REPO: DurableObjectNamespace<import("./src/Worker").AggregateBlockRepo>;
	AGGREGATE_FRONTEND_REPO: DurableObjectNamespace<import("./src/Worker").AggregateFrontendRepo>;
	AGGREGATE_FRONTEND_BLOCK_REPO: DurableObjectNamespace<import("./src/Worker").AggregateFrontendBlockRepo>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TESTING" | "ZEROSPIN_ENVIRONMENT" | "ZEROSPIN_SYSTEM_ID" | "E2E_USER_EMAIL" | "E2E_USER_PASSWORD" | "VITE_ZEROSPIN_API_URL" | "VITE_ZEROSPIN_PUBLISHABLE_KEY" | "VITE_CLERK_PUBLISHABLE_KEY" | "ZEROSPIN_SECRET_KEY" | "CLERK_SECRET_KEY">> {}
}
declare module "*.sql" {
	const value: string;
