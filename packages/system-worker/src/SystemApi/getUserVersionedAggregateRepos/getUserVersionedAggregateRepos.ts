 ...
 */
export const getUserVersionedAggregateRepos = Effect.fn(
  'SystemApi.getUserVersionedAggregateRepos',
)(function* (props: {
  ...
  return yield* makeApiHandler({
    name: 'SystemApi.getUserVersionedAggregateRepos',
    ...
    handler: () =>
      Effect.gen(function* () {
        ...
        // 5 — decode SystemRepo.getRepoRegistrations for UserVersionedAggregateRepo
        ...
        Effect.withSpan('SystemApi.getUserVersionedAggregateRepos', {
          root: true,
        }),
      ),
  })(request).pipe(
