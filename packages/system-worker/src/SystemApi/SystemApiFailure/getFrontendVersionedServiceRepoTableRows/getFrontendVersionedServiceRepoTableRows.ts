...
/*
 * SystemApiFailure.getFrontendVersionedServiceRepoTableRows answers calls on a rejected capability.
...
export const getFrontendVersionedServiceRepoTableRows = Effect.fn(
  'SystemApiFailure.getFrontendVersionedServiceRepoTableRows',
)((props: {
  error: IAnyError;
