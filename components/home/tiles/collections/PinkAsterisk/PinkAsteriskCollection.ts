...
export const pinkAsteriskCollection = makeCollection({
  ...
  tiles: {
    "1x1": makeTile({ name: "1x1", w: 1, h: 1, order: 1, component: PinkAsterisk1x1 }),
    "2x2": makeTile({ name: "2x2", w: 2, h: 2, order: 2, component: PinkAsterisk2x2 }),
    "4x1": makeTile({ name: "4x1", w: 4, h: 1, order: 0, component: PinkAsterisk4x1 }),
  },
});
