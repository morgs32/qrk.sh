 ...
 */
export const getSelectionVersionedAggregateRepoTableRows = Effect.fn(
  ...
  return yield* makeApiHandler({
    name: 'SystemApi.getSelectionVersionedAggregateRepoTableRows',
    ...
    handler: handlerProps =>
      Effect.gen(function* () {
        ...
        // 3 — query SystemRepo for SelectionVersionedAggregateRepo registrations
        ...
        if (
          ...
          return yield* new ZerospinError({
            ...
            message: `SelectionVersionedAggregateRepo "${repoName}" is not registered`,
            extra: {
              repoName,
              repoType: 'SelectionVersionedAggregateRepo',
            },
        ...
        const key =
          yield* SelectionVersionedAggregateRepo.fixedDORepoConfig.nameUtils.parseName(
            repoName,
          );
