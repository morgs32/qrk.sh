...
| CommandRepo finalize, ledger role                                | [commandrepo-ledger-not-finalizer](./2026-06-20-commandrepo-ledger-not-finalizer.md)             | `system-worker/aggregate-repo-finalization-fanout.ts`     |
| fanout debloat                                                   | [fanout-package-debloat](./2026-06-21-fanout-package-debloat.md)                                 | `system-worker/direct-aggregate-frontend-fanout.ts`       |
...
| account finalization mode                                        | [account-repo-finalization](./2026-06-20-account-repo-finalization.md)                           | `system-worker/aggregate-repo-contract-lookup.ts`         |
| closeAccountBatch split                                          | [account-repo-finalization-fanout-split](./2026-06-23-account-repo-finalization-fanout-split.md) | `system-worker/aggregate-repo-finalization-fanout.ts`     |
| snapshot bootstrap, catch-up fanout, frozen projection rejection | [fanout-repo-directory-and-lifecycle](./2026-06-27-fanout-repo-directory-and-lifecycle.md)       | `system-worker/direct-aggregate-frontend-fanout.ts`       |
| applied mutations archive                                        | [applied-mutations-archive-ready](./2026-06-27-applied-mutations-archive-ready.md)               | `system-worker/aggregate-repo-finalization-fanout.ts`     |
