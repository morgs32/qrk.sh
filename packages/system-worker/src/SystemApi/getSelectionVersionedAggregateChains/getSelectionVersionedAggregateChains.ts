 ...
 */
export const getSelectionVersionedAggregateChains = Effect.fn(
  'SystemApi.getSelectionVersionedAggregateChains',
)(function* (props: {
  ...
  return yield* makeApiHandler({
    name: 'SystemApi.getSelectionVersionedAggregateChains',
    ...
    handler: () =>
      Effect.gen(function* () {
        ...
        // 5 — decode SystemRepo.getRepoRegistrations for SelectionVersionedAggregateChain
        ...
        Effect.withSpan('SystemApi.getSelectionVersionedAggregateChains', {
          root: true,
        }),
      ),
  })(request).pipe(
