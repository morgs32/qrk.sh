 ...
 */
export const getUserVersionedAggregateChains = Effect.fn(
  'SystemApi.getUserVersionedAggregateChains',
)(function* (props: {
  ...
  return yield* makeApiHandler({
    name: 'SystemApi.getUserVersionedAggregateChains',
    ...
    handler: () =>
      Effect.gen(function* () {
        ...
        // 5 — decode SystemRepo.getRepoRegistrations for UserVersionedAggregateChain
        ...
        Effect.withSpan('SystemApi.getUserVersionedAggregateChains', {
          root: true,
        }),
      ),
  })(request).pipe(
