/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./worker-configuration.d.ts` (hash: 82eade488480f68deb677a95ff3323c4)
// Runtime types generated with workerd@1.20260507.1 2026-05-14 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/Worker");
		durableNamespaces: "BrowserHost" | "LinktreeRepo" | "BeaconsRepo" | "InstagramRepo" | "GitHubRepo" | "TikTokRepo" | "YouTubeRepo" | "TruthSocialRepo" | "FigmaRepo" | "GooglePlacesRepo";
	}
	interface Env {
		BROWSER: Fetcher;
		GITHUB_TOKEN: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GITHUB_TOKEN" | "PUBLIC_MAPBOX_TOKEN" | "GOOGLE_PLACES_API_KEY" | "FIGMA_TOKEN">> {}
}
