...
/*
 * SystemApiFailure.getUserVersionedAggregateChainTableRows answers calls on a rejected capability.
...
export const getUserVersionedAggregateChainTableRows = Effect.fn(
  'SystemApiFailure.getUserVersionedAggregateChainTableRows',
)((props: {
  error: IAnyError;
