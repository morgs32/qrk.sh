...
test.describe("tile instance path", () => {
  test("clicking a grid tile navigates to /edit-tiles/:collectionName/:instanceId", async ({ page }) => {
    ...
    await expect.poll(() => new URL(page.url()).pathname).toBe("/edit-tiles/orange-flag/orange-flag--0");
  });
  ...
  test("tile drawer shows instance id on /edit-tiles/:collectionName/:instanceId", async ({ page }) => {
    await page.goto("/edit-tiles/orange-flag/orange-flag--0", { waitUntil: "load" });
