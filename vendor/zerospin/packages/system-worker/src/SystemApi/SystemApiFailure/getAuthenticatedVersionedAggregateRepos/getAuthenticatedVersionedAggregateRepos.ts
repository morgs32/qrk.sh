...
/*
 * SystemApiFailure.getAuthenticatedVersionedAggregateRepos answers calls on a rejected capability.
...
export const getAuthenticatedVersionedAggregateRepos = Effect.fn(
  'SystemApiFailure.getAuthenticatedVersionedAggregateRepos',
)((props: {
  error: IAnyError;
