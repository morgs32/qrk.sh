 ...
 * Implements the MaterializedAggregateRepo execute Select Query operation.
...
export const executeSelectQuery = Effect.fn('MaterializedAggregateRepo.executeSelectQuery')(
