 ...
 */
export const getFrontendServiceChains = Effect.fn(
  'SystemApi.getFrontendServiceChains',
)(function* (props: {
  ...
  return yield* makeApiHandler({
    name: 'SystemApi.getFrontendServiceChains',
    ...
    handler: () =>
      Effect.gen(function* () {
        ...
        // 5 — decode SystemRepo.getRepoRegistrations for FrontendServiceChain
        ...
        Effect.withSpan('SystemApi.getFrontendServiceChains', {
          root: true,
        }),
      ),
  })(request).pipe(
