...
function DrawerContent({ className, children, overlayClassName, ...props }: DrawerContentProps) {
  const shouldRenderOverlay = overlayClassName ? !overlayClassName.includes("hidden") : true;
