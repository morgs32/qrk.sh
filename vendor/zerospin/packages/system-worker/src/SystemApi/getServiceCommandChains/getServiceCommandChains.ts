...
export const getServiceCommandChains = Effect.fn('SystemApi.getServiceCommandChains')(
  function* (props: {
    ...
    return yield* makeApiHandler({
      name: 'SystemApi.getServiceCommandChains',
      ...
      handler: () =>
        Effect.gen(function* () {
          ...
          Effect.withSpan('SystemApi.getServiceCommandChains', { root: true }),
        ),
    })(request).pipe(
