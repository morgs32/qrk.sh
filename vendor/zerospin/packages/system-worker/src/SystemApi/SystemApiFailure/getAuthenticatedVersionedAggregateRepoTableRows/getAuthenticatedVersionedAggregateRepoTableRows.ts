...
/*
 * SystemApiFailure.getAuthenticatedVersionedAggregateRepoTableRows answers calls on a rejected capability.
...
export const getAuthenticatedVersionedAggregateRepoTableRows = Effect.fn(
  'SystemApiFailure.getAuthenticatedVersionedAggregateRepoTableRows',
)((props: {
  error: IAnyError;
  request: Parameters<
