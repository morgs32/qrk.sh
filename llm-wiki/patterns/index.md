...
| SelectionVersionedAggregateRepo push, optimistic journal, aggregate forwarding                                                                                                                                                                                                                                    | `system-worker/aggregate-frontend-admission.ts`                   |
| SelectionVersionedAggregateRepo selection, source replica, projection, optimistic replay                                                                                                                                                                                                                          | `system-worker/versioned-aggregate-replica-owned-projection.ts`   |
