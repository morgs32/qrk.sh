...
| chain admission, materializer execution, retained terminal history | [command-chain-materializer-ownership](./2026-08-31-command-chain-materializer-ownership.md)   | `system-worker/aggregate-chain-materialization.ts`         |
