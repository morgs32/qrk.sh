...
export const getFrontendServiceChainTableRows = Effect.fn(
  'SystemApi.getFrontendServiceChainTableRows',
)(function* (props: {
  ...
  return yield* makeApiHandler({
    name: 'SystemApi.getFrontendServiceChainTableRows',
    ...
    handler: handlerProps =>
      Effect.gen(function* () {
        ...
        // 3 — query SystemRepo for FrontendServiceChain registrations
        ...
        if (
          ...
          return yield* new ZerospinError({
            ...
            message: `FrontendServiceChain "${repoName}" is not registered`,
            extra: {
              repoName,
              repoType: 'FrontendServiceChain',
            },
        ...
        const key =
          yield* FrontendServiceChain.fixedDORepoConfig.nameUtils.parseName(
            repoName,
          );
        ...
        Effect.withSpan('SystemApi.getFrontendServiceChainTableRows', {
          root: true,
        }),
      ),
