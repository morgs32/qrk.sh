...
/*
 * SystemApiFailure.getAuthenticatedVersionedAggregateChains answers calls on a rejected capability.
...
export const getAuthenticatedVersionedAggregateChains = Effect.fn(
  'SystemApiFailure.getAuthenticatedVersionedAggregateChains',
)((props: {
  error: IAnyError;
