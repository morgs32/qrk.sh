...
export const userActor = makeActorController({
  name: "user",
  version: "1.1.0",
  models: {
    grid: Grid,
  ...
  frontends: {
    web: {
      frontendController: userFrontend,
      authenticate: Effect.fn("user.authenticate")(function* ({
        signature,
        db,
        makeAccountCommand,
