 ...
 */
export const getAggregateChains = Effect.fn('SystemApi.getAggregateChains')(
  function* (props: {
    ...
    return yield* makeApiHandler({
      name: 'SystemApi.getAggregateChains',
      ...
      handler: () =>
        Effect.gen(function* () {
          ...
          // 5 — decode SystemRepo.getRepoRegistrations for AggregateChain
