 ...
 */
export const getAuthenticatedVersionedAggregateChains = Effect.fn(
  'SystemApi.getAuthenticatedVersionedAggregateChains',
)(function* (props: {
  request: Parameters<SystemApi['getAuthenticatedVersionedAggregateChains']>[0];
  ...
  return yield* makeApiHandler({
    name: 'SystemApi.getAuthenticatedVersionedAggregateChains',
    ...
    handler: () =>
      Effect.gen(function* () {
        ...
        // 5 — decode SystemRepo.getRepoRegistrations for AuthenticatedVersionedAggregateChain
        ...
        Effect.withSpan('SystemApi.getAuthenticatedVersionedAggregateChains', {
          root: true,
        }),
      ),
  })(request).pipe(
