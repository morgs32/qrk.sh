...
declare namespace Cloudflare {
	...
	interface Env {
		...
		GOOGLE_PLACES_REPO: DurableObjectNamespace<import("./src/Worker").GooglePlacesRepo>;
		LINK_REPO: DurableObjectNamespace<import("./src/Worker").LinkRepo>;
		STREAMLINE_REPO: DurableObjectNamespace<import("./src/Worker").StreamlineRepo>;
