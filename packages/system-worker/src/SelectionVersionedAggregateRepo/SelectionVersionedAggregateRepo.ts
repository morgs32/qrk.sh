...
export class SelectionVersionedAggregateRepo extends makeFixedDORepo({
  namespaceBinding: 'SELECTION_VERSIONED_AGGREGATE_REPO',
  fixedDORepoConfig: selectionVersionedAggregateRepoFixedDORepoConfig,
}) {
  static override readonly fixedDORepoConfig =
    selectionVersionedAggregateRepoFixedDORepoConfig;
   ...
   * that cursor, then reconcile requested command outcomes from SelectionVAC.
