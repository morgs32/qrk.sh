/* eslint-disable */
// Generated by Wrangler by running `wrangler types -c ./wrangler.jsonc` (hash: 4339b71003f871af592184d108c0da07)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		ZEROSPIN_SYSTEM_ID: "sys_parking";
		...
		SERVICE_FRONTEND_REPO: DurableObjectNamespace<import("./src/Worker").ServiceFrontendRepo>;
		SERVICE_FRONTEND_BLOCK_REPO: DurableObjectNamespace<import("./src/Worker").ServiceFrontendBlockRepo>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TESTING" | "ZEROSPIN_DEPLOY_ID" | "ZEROSPIN_ENVIRONMENT_ID" | "ZEROSPIN_GENERATION_ID" | "ZEROSPIN_INSTANCE_ID" | "ZEROSPIN_SYSTEM_ID">> {}
}
declare module "*.sql" {
	const value: string;
