...
/*
 * SystemApiFailure.getSelectionVersionedAggregateRepoTableRows answers calls on a rejected capability.
...
export const getSelectionVersionedAggregateRepoTableRows = Effect.fn(
  'SystemApiFailure.getSelectionVersionedAggregateRepoTableRows',
)((props: {
  error: IAnyError;
  request: Parameters<
