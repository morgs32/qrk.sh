 ...
 */
export const getState = Effect.fn('SelectionVersionedAggregateRepo.getState')(
  function* (
    props: Parameters<typeof catchup>[0] & {
      ...
      serviceSubscriber: (sourceKey: {
        ...
        ReturnType<
          SelectionVersionedAggregateRepo['aggregateReplicaFanoutQueueSubscriber']
        >,
        'catchup'
      >;
      requested: {
      ...
      deltas: Pick<SelectionVersionedAggregateRepo['deltas'], 'drain'>;
    },
  ) {
