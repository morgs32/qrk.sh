/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./worker-configuration.d.ts` (hash: ebf5cc7caa91998c863ec0c78fc94a1b)
// Runtime types generated with workerd@1.20260507.1 2026-07-02 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/Worker");
		durableNamespaces: "ScraperRepo";
	}
	interface Env {
		LINKTREE_QUEUE: Queue;
		BEACONS_QUEUE: Queue;
		INSTAGRAM_QUEUE: Queue;
		TIKTOK_QUEUE: Queue;
		YOUTUBE_QUEUE: Queue;
		TRUTH_SOCIAL_QUEUE: Queue;
		BROWSER: Fetcher;
		SCRAPER_REPO: DurableObjectNamespace<import("./src/Worker").ScraperRepo>;
	}
}
