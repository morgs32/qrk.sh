 ...
 */
export const getSelectionVersionedAggregateChainTableRows = Effect.fn(
  ...
  return yield* makeApiHandler({
    name: 'SystemApi.getSelectionVersionedAggregateChainTableRows',
    ...
    handler: handlerProps =>
      Effect.gen(function* () {
        ...
        // 3 — query SystemRepo for SelectionVersionedAggregateChain registrations
        ...
        if (
          ...
          return yield* new ZerospinError({
            ...
            message: `SelectionVersionedAggregateChain "${repoName}" is not registered`,
            extra: {
              repoName,
              repoType: 'SelectionVersionedAggregateChain',
            },
        ...
        const repo = yield* SelectionVersionedAggregateChain.getRepo({
          key: {
            systemId: authResults.systemId,
