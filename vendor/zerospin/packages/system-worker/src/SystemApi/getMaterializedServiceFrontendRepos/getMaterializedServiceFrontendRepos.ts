...
export const getMaterializedServiceFrontendRepos = Effect.fn(
  'SystemApi.getMaterializedServiceFrontendRepos',
)(function* (props: {
  ...
  return yield* makeApiHandler({
    name: 'SystemApi.getMaterializedServiceFrontendRepos',
    ...
    handler: () =>
      Effect.gen(function* () {
        ...
        Effect.withSpan('SystemApi.getMaterializedServiceFrontendRepos', { root: true }),
      ),
  })(request).pipe(
