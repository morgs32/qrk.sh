...
/*
 * SystemApiFailure.getSelectionVersionedAggregateChainTableRows answers calls on a rejected capability.
...
export const getSelectionVersionedAggregateChainTableRows = Effect.fn(
  'SystemApiFailure.getSelectionVersionedAggregateChainTableRows',
)((props: {
  error: IAnyError;
  request: Parameters<
