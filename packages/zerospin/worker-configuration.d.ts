/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=../../apps/web/wrangler.jsonc ./worker-configuration.d.ts` (hash: 831c124c58bbdecb4c4dc2686bcb3046)
// Runtime types generated with workerd@1.20260625.1 2026-01-20 nodejs_compat
interface __BaseEnv_Env {
	TESTING: false;
	CLERK_AUTHORIZED_PARTY: "http://localhost:4000";
	ZEROSPIN_ENVIRONMENT_ID: "zerospin-dev";
	ZEROSPIN_SYSTEM_ID: "sys_qrk_sh_1";
	ZEROSPIN_SYSTEM_VERSION: "3.0.0";
	NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY: string;
	CLERK_SECRET_KEY: string;
	PORT: string;
	ZEROSPIN_PORT: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TESTING" | "CLERK_AUTHORIZED_PARTY" | "ZEROSPIN_ENVIRONMENT_ID" | "ZEROSPIN_SYSTEM_ID" | "ZEROSPIN_SYSTEM_VERSION" | "NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY" | "CLERK_SECRET_KEY" | "PORT" | "ZEROSPIN_PORT" | "NEXT_PUBLIC_ZEROSPIN_API_URL" | "NEXT_PUBLIC_ZEROSPIN_PUBLISHABLE_KEY" | "ZEROSPIN_SECRET_KEY">> {}
}
declare module "*.sql" {
	const value: string;
