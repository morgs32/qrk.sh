 ...
 */
export const getFrontendVersionedServiceRepos = Effect.fn(
  'SystemApi.getFrontendVersionedServiceRepos',
)(function* (props: {
  ...
  return yield* makeApiHandler({
    name: 'SystemApi.getFrontendVersionedServiceRepos',
    ...
    handler: () =>
      Effect.gen(function* () {
        ...
        // 5 — decode SystemRepo.getRepoRegistrations for FrontendVersionedServiceRepo
        ...
        Effect.withSpan('SystemApi.getFrontendVersionedServiceRepos', {
          root: true,
        }),
      ),
  })(request).pipe(
