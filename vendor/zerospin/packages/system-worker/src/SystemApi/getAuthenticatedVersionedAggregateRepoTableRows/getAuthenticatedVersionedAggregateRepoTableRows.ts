 ...
 */
export const getAuthenticatedVersionedAggregateRepoTableRows = Effect.fn(
  ...
  return yield* makeApiHandler({
    name: 'SystemApi.getAuthenticatedVersionedAggregateRepoTableRows',
    ...
    handler: handlerProps =>
      Effect.gen(function* () {
        ...
        // 3 — query SystemRepo for AuthenticatedVersionedAggregateRepo registrations
        ...
        if (
          ...
          return yield* new ZerospinError({
            ...
            message: `AuthenticatedVersionedAggregateRepo "${repoName}" is not registered`,
            extra: {
              repoName,
              repoType: 'AuthenticatedVersionedAggregateRepo',
            },
        ...
        const key =
          yield* AuthenticatedVersionedAggregateRepo.fixedDORepoConfig.nameUtils.parseName(
            repoName,
          );
