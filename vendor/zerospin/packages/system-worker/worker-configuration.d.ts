/* eslint-disable */
// Generated by Wrangler by running `wrangler types -c ./wrangler.jsonc` (hash: da7fc232902e0a1cbddba6535ab90642)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "SystemRepo" | "AggregateRepo" | "ServiceRepo" | "AggregateBlockRepo" | "AggregateFrontendRepo" | "AggregateFrontendBlockRepo" | "ServiceBlockRepo" | "ServiceFrontendRepo" | "ServiceFrontendBlockRepo" | "SystemLogRepo" | "SystemLogAgent";
	}
	interface Env {
		...
		AGGREGATE_REPO: DurableObjectNamespace<import("./src/SystemWorker").AggregateRepo>;
		SERVICE_REPO: DurableObjectNamespace<import("./src/SystemWorker").ServiceRepo>;
		AGGREGATE_BLOCK_REPO: DurableObjectNamespace<import("./src/SystemWorker").AggregateBlockRepo>;
		AGGREGATE_FRONTEND_REPO: DurableObjectNamespace<import("./src/SystemWorker").AggregateFrontendRepo>;
		AGGREGATE_FRONTEND_BLOCK_REPO: DurableObjectNamespace<import("./src/SystemWorker").AggregateFrontendBlockRepo>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TESTING" | "ZEROSPIN_ENVIRONMENT" | "ZEROSPIN_SYSTEM_ID">> {}
}
