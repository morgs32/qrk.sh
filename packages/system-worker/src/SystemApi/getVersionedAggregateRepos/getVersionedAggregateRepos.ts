 ...
 */
export const getVersionedAggregateRepos = Effect.fn(
  'SystemApi.getVersionedAggregateRepos',
)(function* (props: {
  ...
  return yield* makeApiHandler({
    name: 'SystemApi.getVersionedAggregateRepos',
    ...
    handler: () =>
      Effect.gen(function* () {
        ...
        // 5 — decode SystemRepo.getRepoRegistrations for VersionedAggregateRepo
        ...
        Effect.withSpan('SystemApi.getVersionedAggregateRepos', {
          root: true,
        }),
      ),
  })(request).pipe(
