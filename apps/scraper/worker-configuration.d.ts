/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./worker-configuration.d.ts` (hash: da3aeb09dcf7b06d26dc34bd50fd63cf)
// Runtime types generated with workerd@1.20260911.1 2026-05-14 nodejs_compat
interface __BaseEnv_Env {
	BROWSER: BrowserRun;
	BROWSER_HOST: DurableObjectNamespace<import("./Worker").BrowserHost>;
	LINKTREE_REPO: DurableObjectNamespace<import("./Worker").LinktreeRepo>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./Worker");
		durableNamespaces: "BrowserHost" | "LinktreeRepo";
	}
