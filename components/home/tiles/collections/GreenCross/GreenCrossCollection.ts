...
export const greenCrossCollection = makeCollection({
  ...
  tiles: {
    "2x2": makeTile({ name: "2x2", w: 2, h: 2, order: 0, component: GreenCross1x1 }),
    "4x4": makeTile({ name: "4x4", w: 4, h: 4, order: 1, component: GreenCross2x2 }),
    "8x2": makeTile({ name: "8x2", w: 8, h: 2, order: 2, component: GreenCross4x1 }),
  },
});
