...
/*
 * SystemApi lists VersionedServiceChain instances recorded in its deployment
 ...
 */
export const getVersionedServiceChains = Effect.fn(
  'SystemApi.getVersionedServiceChains',
)(function* (props: {
  ...
  return yield* makeApiHandler({
    name: 'SystemApi.getVersionedServiceChains',
    ...
    handler: () =>
      Effect.gen(function* () {
        ...
        // 5 — decode SystemRepo.getRepoRegistrations for VersionedServiceChain
        ...
        Effect.withSpan('SystemApi.getVersionedServiceChains', {
          root: true,
        }),
      ),
  })(request).pipe(
