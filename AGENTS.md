...
5. **Tile catalog types** — `ICollectionTileDef`, pair-based grid hooks (`data-tile-grid-collection-name` / `data-tile-grid-tile-name` on [Grid.tsx](components/home/Grid.tsx)), drag def vs component.
