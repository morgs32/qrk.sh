/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=./wrangler.jsonc` (hash: f4197a63257c4c5718c7962fc55ab070)
...
interface __BaseEnv_Env {
	...
	MATERIALIZED_AGGREGATE_REPO: DurableObjectNamespace<import("./src/Worker").MaterializedAggregateRepo>;
	MATERIALIZED_SERVICE_REPO: DurableObjectNamespace<import("./src/Worker").MaterializedServiceRepo>;
	AGGREGATE_COMMAND_CHAIN: DurableObjectNamespace<import("./src/Worker").AggregateCommandChain>;
	AGGREGATE_FRONTEND_PUSHED_COMMAND_CHAIN: DurableObjectNamespace<import("./src/Worker").AggregateFrontendPushedCommandChain>;
	MATERIALIZED_AGGREGATE_FRONTEND_REPO: DurableObjectNamespace<import("./src/Worker").MaterializedAggregateFrontendRepo>;
	AGGREGATE_FRONTEND_FINALIZED_COMMAND_CHAIN: DurableObjectNamespace<import("./src/Worker").AggregateFrontendFinalizedCommandChain>;
	SERVICE_COMMAND_CHAIN: DurableObjectNamespace<import("./src/Worker").ServiceCommandChain>;
	MATERIALIZED_SERVICE_FRONTEND_REPO: DurableObjectNamespace<import("./src/Worker").MaterializedServiceFrontendRepo>;
	SERVICE_FRONTEND_FINALIZED_COMMAND_CHAIN: DurableObjectNamespace<import("./src/Worker").ServiceFrontendFinalizedCommandChain>;
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "SystemRepo" | "MaterializedAggregateRepo" | "MaterializedServiceRepo" | "AggregateCommandChain" | "AggregateFrontendPushedCommandChain" | "MaterializedAggregateFrontendRepo" | "AggregateFrontendFinalizedCommandChain" | "ServiceCommandChain" | "MaterializedServiceFrontendRepo" | "ServiceFrontendFinalizedCommandChain" | "SystemLogRepo" | "SystemLogAgent";
	}
