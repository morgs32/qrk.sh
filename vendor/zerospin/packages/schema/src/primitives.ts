...
export type IDrizzleTimestampColumnBuilder = ReturnType<
  typeof drizzleInteger<'timestamp_ms'>
>;
...
function integer(props: {
  ...
  primaryKey: true;
  defaultValue?: undefined;
}): IIntegerDescriptor<false, undefined> & { primaryKey: true };
function integer(props?: {
  nullable?: false | undefined;
  unique?: boolean;
  primaryKey?: false | undefined;
...
function json<DATA>(props: {
  schema: Schema.Codec<DATA, unknown>;
  nullable: true;
  defaultValue: null;
...
> &
  (TABLE['shape'][{
    [KEY in keyof TABLE['shape'] & string]: TABLE['shape'][KEY] extends
      ...
      ? KEY
      : never;
  }[keyof TABLE['shape'] & string]] extends IIntegerDescriptor & {
    primaryKey: true;
  }
...
function ref(props: {
  ...
  let targetPrimaryKey: IPrimaryKeyDescriptor | IIntegerDescriptor | undefined;
  ...
  return {
    ...
    unique,
    abbreviation:
      targetPrimaryKey.kind === PrimitiveKind.PrimaryKey
        ? targetPrimaryKey.abbreviation
        : '',
    ...(targetPrimaryKey.kind === PrimitiveKind.Integer
      ? { targetKind: PrimitiveKind.Integer }
      : {}),
    table,
