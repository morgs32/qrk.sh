...
import type {
  IVersionedDORepoConfig,
  IVersionedDORepoMigration,
} from './types.js';

/** VersionedDORepo configuration: fixed config fields plus ordered SQL migrations. */
/*
 * Repo declarations normalize their versioned lifecycle configuration here.
 * The result binds name utilities, runtime, database resolution, and bootstrap
 * plus the supplied ordered migration definitions.
 *
 ...
 */
export function makeVersionedDORepoConfig<
...
>(props: {
  ...
  migrations: readonly IVersionedDORepoMigration[];
  bootstrap?: (props: {
