...
export const getAggregateFrontendFinalizedCommandChains = Effect.fn(
  'SystemApi.getAggregateFrontendFinalizedCommandChains',
)(function* (props: {
  ...
  return yield* makeApiHandler({
    name: 'SystemApi.getAggregateFrontendFinalizedCommandChains',
    ...
    handler: () =>
      Effect.gen(function* () {
        ...
        Effect.withSpan('SystemApi.getAggregateFrontendFinalizedCommandChains', {
          root: true,
        }),
      ),
  })(request).pipe(
