...
export function TanStackRouteErrorBoundary(props: { error: unknown }) {
  const { error } = props;
  ...
  if (ZerospinError.isZerospinError(error)) {
    ...
    status = 404;
    structuredDetailsLabel = error.data === undefined ? null : "Not found data";
      ...
      >
          ...
          <div className="zerospin-route-error__heading">
            <div className="zerospin-route-error__identity">
              <div className="zerospin-route-error__title-row">
                ...
                {status === null ? null : (
                  <span className="zerospin-route-error__status">Status {status}</span>
                )}
              </div>
              {errorCode === null ? null : (
        ...
        <footer className="zerospin-route-error__footer">
          <button
            ...
            disabled={typeof navigator === "undefined" || navigator.clipboard === undefined}
            onClick={() => {
