 ...
 */
export const getFrontendVersionedServiceRepoTableRows = Effect.fn(
  'SystemApi.getFrontendVersionedServiceRepoTableRows',
)(function* (props: {
  request: Parameters<SystemApi['getFrontendVersionedServiceRepoTableRows']>[0];
  ...
  return yield* makeApiHandler({
    name: 'SystemApi.getFrontendVersionedServiceRepoTableRows',
    ...
    handler: handlerProps =>
      Effect.gen(function* () {
        ...
        // 3 — query SystemRepo for FrontendVersionedServiceRepo registrations
        ...
        if (
          ...
          return yield* new ZerospinError({
            ...
            message: `FrontendVersionedServiceRepo "${repoName}" is not registered`,
            extra: {
              repoName,
              repoType: 'FrontendVersionedServiceRepo',
            },
        ...
        const key =
          yield* FrontendVersionedServiceRepo.fixedDORepoConfig.nameUtils.parseName(
            repoName,
          );
        const repo = yield* FrontendVersionedServiceRepo.getRepo({
          key: {
            systemId: authResults.systemId,
        ...
        Effect.withSpan('SystemApi.getFrontendVersionedServiceRepoTableRows', {
          root: true,
        }),
      ),
