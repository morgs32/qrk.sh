...
/*
 * SystemApiFailure.getAuthenticatedVersionedAggregateChainTableRows answers calls on a rejected capability.
...
export const getAuthenticatedVersionedAggregateChainTableRows = Effect.fn(
  'SystemApiFailure.getAuthenticatedVersionedAggregateChainTableRows',
)((props: {
  error: IAnyError;
  request: Parameters<
