/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=./wrangler.vitest.jsonc` (hash: 9677cbfaae9c8e560cf312f4b32c479f)
...
interface __BaseEnv_Env {
	...
	CLOUD_REPO: DurableObjectNamespace<import("./src/Worker").CloudRepo>;
	ACTOR_REPO: DurableObjectNamespace<import("./src/Worker").ActorRepo>;
	SURFACE_REPO: DurableObjectNamespace<import("./src/Worker").SurfaceRepo>;
	...
	FINALIZED_COMMAND_REPO: DurableObjectNamespace<import("./src/Worker").FinalizedCommandRepo>;
	AUTHORIZATION_REPO: DurableObjectNamespace<import("./src/Worker").AuthorizationRepo>;
	ACCOUNT_DELTA_FANOUT_REPO: DurableObjectNamespace<import("./src/Worker").AccountDeltaFanout>;
	ACTOR_DELTA_FANOUT_REPO: DurableObjectNamespace<import("./src/Worker").ActorDeltaFanout>;
	SURFACE_DELTA_FANOUT_REPO: DurableObjectNamespace<import("./src/Worker").SurfaceDeltaFanout>;
	FRONTEND_DELTA_FANOUT_REPO: DurableObjectNamespace<import("./src/Worker").FrontendDeltaFanout>;
	FRONTEND_WEBSOCKET_SUBSCRIBER: DurableObjectNamespace<import("./src/Worker").FrontendWebSocketSubscriber>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/Worker");
		durableNamespaces: "ActorRepo" | "SurfaceRepo" | "FrontendRepo" | "SystemRepo" | "AccountRepo" | "CloudRepo" | "FinalizedCommandRepo" | "AuthorizationRepo" | "AccountDeltaFanout" | "ActorDeltaFanout" | "SurfaceDeltaFanout" | "FrontendDeltaFanout" | "FrontendWebSocketSubscriber";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TESTING" | "ZEROSPIN_ENVIRONMENT_ID" | "CLOUD_CLERK_SECRET_KEY" | "CLOUD_CLERK_PUBLISHABLE_KEY" | "ADMIN_CLERK_SECRET_KEY" | "ADMIN_CLERK_PUBLISHABLE_KEY" | "CLOUD_CLERK_JWKS_ENDPOINT">> {}
}
declare module "*.sql" {
	const value: string;
