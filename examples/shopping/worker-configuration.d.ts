/* eslint-disable */
// Generated by Wrangler by running `wrangler types -c ./wrangler.jsonc` (hash: 2fdeeea95bb596f9689d8a877e9c8682)
// Runtime types generated with workerd@1.20260507.1 2026-01-20 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		NEXT_PUBLIC_CLERK_UNSAFE_DISABLE_DEVELOPMENT_MODE_CONSOLE_WARNING: string;
		NEXT_PUBLIC_ZEROSPIN_PUBLISHABLE_KEY: string;
		ZEROSPIN_SECRET_KEY: string;
		NEXT_PUBLIC_ZEROSPIN_API_URL: string;
		ACTOR_REPO: DurableObjectNamespace<import("./src/Worker").ActorRepo>;
		SYSTEM_REPO: DurableObjectNamespace<import("./src/Worker").SystemRepo>;
		ACCOUNT_REPO: DurableObjectNamespace<import("./src/Worker").AccountRepo>;
		SERVICE_REPO: DurableObjectNamespace<import("./src/Worker").ServiceRepo>;
		ACCOUNT_BLOCK_REPO: DurableObjectNamespace<import("./src/Worker").AccountBlockRepo>;
		ACTOR_BLOCK_REPO: DurableObjectNamespace<import("./src/Worker").ActorBlockRepo>;
		FRONTEND_REPO: DurableObjectNamespace<import("./src/Worker").FrontendRepo>;
		FRONTEND_BLOCK_REPO: DurableObjectNamespace<import("./src/Worker").FrontendBlockRepo>;
		SERVICE_BLOCK_REPO: DurableObjectNamespace<import("./src/Worker").ServiceBlockRepo>;
		AUTHORIZATION_REPO: DurableObjectNamespace<import("./src/Worker").AuthorizationRepo>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TESTING" | "ZEROSPIN_DEPLOY_ID" | "ZEROSPIN_ENVIRONMENT_ID" | "ZEROSPIN_GENERATION_ID" | "ZEROSPIN_INSTANCE_ID" | "ZEROSPIN_SYSTEM_ID" | "NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY" | "CLERK_SECRET_KEY" | "NEXT_PUBLIC_CLERK_SIGN_IN_URL" | "NEXT_PUBLIC_CLERK_SIGN_UP_URL" | "NEXT_PUBLIC_CLERK_UNSAFE_DISABLE_DEVELOPMENT_MODE_CONSOLE_WARNING" | "NEXT_PUBLIC_ZEROSPIN_PUBLISHABLE_KEY" | "ZEROSPIN_SECRET_KEY" | "NEXT_PUBLIC_ZEROSPIN_API_URL">> {}
}
declare module "*.sql" {
	const value: string;
