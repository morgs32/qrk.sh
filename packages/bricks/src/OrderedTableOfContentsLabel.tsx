...
export function OrderedTableOfContentsLabel({
  ...
  return (
    <div
      ...
      className={`flex items-baseline pr-4 py-2 before:w-[var(--toc-marker-width)] before:shrink-0 before:text-zinc-400 before:content-[counter(toc-item,var(--toc-style))] ${sticky ? "sticky top-0 z-10 bg-zinc-100" : ""}`}
    >
