/* eslint-disable */
// Generated by Wrangler by running `wrangler types -c ./wrangler.jsonc` (hash: 385eca32fe9a500354c935b50f04bd54)
// Runtime types generated with workerd@1.20260507.1 2025-04-16 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/SystemWorker");
		durableNamespaces: "ActorRepo" | "SystemRepo" | "AccountRepo" | "ServiceRepo" | "AccountBlockRepo" | "ActorBlockRepo" | "AuthorizationRepo" | "SystemLogRepo" | "SystemLogAgent" | "FrontendRepo" | "FrontendBlockRepo" | "ServiceBlockRepo" | "ServiceFrontendRepo" | "ServiceFrontendBlockRepo";
	}
	interface Env {
		ZEROSPIN_VERSION_METADATA: WorkerVersionMetadata;
		TESTING: false;
		ZEROSPIN_ENVIRONMENT_ID: "zerospin-dev";
		ZEROSPIN_DEPLOY_ID: "dpl_test";
		ZEROSPIN_GENERATION_ID: "gen_test";
		...
		SYSTEM_REPO: DurableObjectNamespace<import("./src/SystemWorker").SystemRepo>;
		ACCOUNT_REPO: DurableObjectNamespace<import("./src/SystemWorker").AccountRepo>;
		SERVICE_REPO: DurableObjectNamespace<import("./src/SystemWorker").ServiceRepo>;
		ACCOUNT_BLOCK_REPO: DurableObjectNamespace<import("./src/SystemWorker").AccountBlockRepo>;
		ACTOR_BLOCK_REPO: DurableObjectNamespace<import("./src/SystemWorker").ActorBlockRepo>;
		FRONTEND_REPO: DurableObjectNamespace<import("./src/SystemWorker").FrontendRepo>;
		FRONTEND_BLOCK_REPO: DurableObjectNamespace<import("./src/SystemWorker").FrontendBlockRepo>;
		SERVICE_BLOCK_REPO: DurableObjectNamespace<import("./src/SystemWorker").ServiceBlockRepo>;
		SERVICE_FRONTEND_REPO: DurableObjectNamespace<import("./src/SystemWorker").ServiceFrontendRepo>;
		SERVICE_FRONTEND_BLOCK_REPO: DurableObjectNamespace<import("./src/SystemWorker").ServiceFrontendBlockRepo>;
		AUTHORIZATION_REPO: DurableObjectNamespace<import("./src/SystemWorker").AuthorizationRepo>;
		SYSTEM_LOG_REPO: DurableObjectNamespace<import("./src/SystemWorker").SystemLogRepo>;
		SYSTEM_LOG_AGENT: DurableObjectNamespace<import("./src/SystemWorker").SystemLogAgent>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TESTING" | "ZEROSPIN_ENVIRONMENT_ID" | "ZEROSPIN_DEPLOY_ID" | "ZEROSPIN_GENERATION_ID" | "ZEROSPIN_INSTANCE_ID" | "ZEROSPIN_SYSTEM_ID">> {}
}
...
interface UnderlyingSink<W = any> {
  type?: string;
  start?: (frontend: WritableStreamDefaultController) => void | Promise<void>;
  write?: (
    chunk: W,
    frontend: WritableStreamDefaultController,
  ) => void | Promise<void>;
...
interface UnderlyingByteSource {
  ...
  start?: (frontend: ReadableByteStreamController) => void | Promise<void>;
  pull?: (frontend: ReadableByteStreamController) => void | Promise<void>;
  cancel?: (reason: any) => void | Promise<void>;
}
interface UnderlyingSource<R = any> {
  type?: '' | undefined;
  start?: (
    frontend: ReadableStreamDefaultController<R>,
  ) => void | Promise<void>;
  pull?: (frontend: ReadableStreamDefaultController<R>) => void | Promise<void>;
  cancel?: (reason: any) => void | Promise<void>;
...
interface Transformer<I = any, O = any> {
  ...
  writableType?: string;
  start?: (
    frontend: TransformStreamDefaultController<O>,
  ) => void | Promise<void>;
  transform?: (
    chunk: I,
    frontend: TransformStreamDefaultController<O>,
...
declare namespace CloudflareWorkersModule {
    ...
    implements Rpc.WorkerEntrypointBranded
  {
    ...
    scheduled?(frontend: ScheduledController): void | Promise<void>;
    ...
    test?(frontend: TestController): void | Promise<void>;
