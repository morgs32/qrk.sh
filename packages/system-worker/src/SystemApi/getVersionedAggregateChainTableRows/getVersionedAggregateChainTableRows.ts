...
export const getVersionedAggregateChainTableRows = Effect.fn(
  'SystemApi.getVersionedAggregateChainTableRows',
)(function* (props: {
  ...
  return yield* makeApiHandler({
    name: 'SystemApi.getVersionedAggregateChainTableRows',
    ...
    handler: handlerProps =>
      Effect.gen(function* () {
        ...
        // 3 — query SystemRepo for VersionedAggregateChain registrations
        ...
        if (
          ...
          return yield* new ZerospinError({
            ...
            message: `VersionedAggregateChain "${repoName}" is not registered`,
            extra: {
              repoName,
              repoType: 'VersionedAggregateChain',
            },
        ...
        const key =
          yield* VersionedAggregateChain.fixedDORepoConfig.nameUtils.parseName(
            repoName,
          );
        const repo = yield* VersionedAggregateChain.getRepo({
          key: {
            systemId: authResults.systemId,
        ...
        Effect.withSpan('SystemApi.getVersionedAggregateChainTableRows', {
          root: true,
        }),
      ),
