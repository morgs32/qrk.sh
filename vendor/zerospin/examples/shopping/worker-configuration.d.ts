/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=./wrangler.jsonc` (hash: 3b1476cd89b2c4156b75789f15aa5919)
// Runtime types generated with workerd@1.20260828.1 2026-01-20 nodejs_compat
interface __BaseEnv_Env {
	ZEROSPIN_ENVIRONMENT: "dev";
	ZEROSPIN_SYSTEM_ID: "sys_shopping_20260907_pinned_replicas";
	E2E_USER_EMAIL: string;
	E2E_USER_PASSWORD: string;
	VITE_ZEROSPIN_API_URL: string;
	VITE_ZEROSPIN_PUBLISHABLE_KEY: string;
	VITE_CLERK_PUBLISHABLE_KEY: string;
	ZEROSPIN_SECRET_KEY: string;
	CLERK_SECRET_KEY: string;
	SYSTEM_REPO: DurableObjectNamespace<import("./src/Worker").SystemRepo>;
	VERSIONED_AGGREGATE_REPO: DurableObjectNamespace<import("./src/Worker").VersionedAggregateRepo>;
	VERSIONED_SERVICE_REPO: DurableObjectNamespace<import("./src/Worker").VersionedServiceRepo>;
	AGGREGATE_CHAIN: DurableObjectNamespace<import("./src/Worker").AggregateChain>;
	VERSIONED_AGGREGATE_CHAIN: DurableObjectNamespace<import("./src/Worker").VersionedAggregateChain>;
	VERSIONED_SERVICE_CHAIN: DurableObjectNamespace<import("./src/Worker").VersionedServiceChain>;
	USER_VERSIONED_AGGREGATE_REPO: DurableObjectNamespace<import("./src/Worker").UserVersionedAggregateRepo>;
	USER_VERSIONED_AGGREGATE_CHAIN: DurableObjectNamespace<import("./src/Worker").UserVersionedAggregateChain>;
	SERVICE_ADMITTED_CHAIN: DurableObjectNamespace<import("./src/Worker").ServiceAdmittedChain>;
	FRONTEND_VERSIONED_SERVICE_REPO: DurableObjectNamespace<import("./src/Worker").FrontendVersionedServiceRepo>;
	FRONTEND_SERVICE_CHAIN: DurableObjectNamespace<import("./src/Worker").FrontendServiceChain>;
	SYSTEM_LOG_REPO: DurableObjectNamespace<import("./src/Worker").SystemLogRepo>;
	SYSTEM_LOG_AGENT: DurableObjectNamespace<import("./src/Worker").SystemLogAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/Worker");
		durableNamespaces: "SystemRepo" | "VersionedAggregateRepo" | "VersionedServiceRepo" | "AggregateChain" | "VersionedAggregateChain" | "VersionedServiceChain" | "UserVersionedAggregateRepo" | "UserVersionedAggregateChain" | "ServiceAdmittedChain" | "FrontendVersionedServiceRepo" | "FrontendServiceChain" | "SystemLogRepo" | "SystemLogAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ZEROSPIN_ENVIRONMENT" | "ZEROSPIN_SYSTEM_ID" | "E2E_USER_EMAIL" | "E2E_USER_PASSWORD" | "VITE_ZEROSPIN_API_URL" | "VITE_ZEROSPIN_PUBLISHABLE_KEY" | "VITE_CLERK_PUBLISHABLE_KEY" | "ZEROSPIN_SECRET_KEY" | "CLERK_SECRET_KEY">> {}
}
...
type AudioParams = {
    ...
    format: "wav" | "ac" | "mp3" | "flac" | "opus" | "pcm16";
};
...
interface Ai_Cf_Deepgram_Aura_1_Input {
     ...
     */
    encoding?: "linear16" | "flac" | "mulaw" | "alaw" | "mp3" | "opus" | "ac";
    /**
