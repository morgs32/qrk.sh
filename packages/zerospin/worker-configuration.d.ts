/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=../../apps/web/wrangler.jsonc ./worker-configuration.d.ts` (hash: eedb3b9549b2691b707d7b8c48560d51)
...
interface __BaseEnv_Env {
	...
	LOG_REPO: DurableObjectNamespace<import("./src/Worker").LogRepo>;
	LOG_AGENT: DurableObjectNamespace<import("./src/Worker").LogAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/Worker");
		durableNamespaces: "ActorRepo" | "SystemRepo" | "AccountRepo" | "ServiceRepo" | "AccountBlockRepo" | "ActorBlockRepo" | "AuthorizationRepo" | "LogRepo" | "LogAgent" | "FrontendRepo" | "FrontendBlockRepo" | "ServiceBlockRepo";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TESTING" | "CLERK_AUTHORIZED_PARTY" | "ZEROSPIN_ENVIRONMENT_ID" | "ZEROSPIN_SYSTEM_ID" | "ZEROSPIN_SYSTEM_VERSION" | "NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY" | "CLERK_SECRET_KEY" | "NEXT_PUBLIC_ZEROSPIN_PUBLISHABLE_KEY" | "ZEROSPIN_SECRET_KEY">> {}
}
declare module "*.sql" {
	const value: string;
