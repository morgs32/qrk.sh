 ...
 */
export const getVersionedAggregateChains = Effect.fn(
  'SystemApi.getVersionedAggregateChains',
)(function* (props: {
  ...
  return yield* makeApiHandler({
    name: 'SystemApi.getVersionedAggregateChains',
    ...
    handler: () =>
      Effect.gen(function* () {
        ...
        // 5 — decode SystemRepo.getRepoRegistrations for VersionedAggregateChain
        ...
        Effect.withSpan('SystemApi.getVersionedAggregateChains', {
          root: true,
        }),
      ),
  })(request).pipe(
