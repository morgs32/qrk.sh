 ...
 */
export const getSelectionVersionedAggregateRepos = Effect.fn(
  'SystemApi.getSelectionVersionedAggregateRepos',
)(function* (props: {
  ...
  return yield* makeApiHandler({
    name: 'SystemApi.getSelectionVersionedAggregateRepos',
    ...
    handler: () =>
      Effect.gen(function* () {
        ...
        // 5 — decode SystemRepo.getRepoRegistrations for SelectionVersionedAggregateRepo
        ...
        Effect.withSpan('SystemApi.getSelectionVersionedAggregateRepos', {
          root: true,
        }),
      ),
  })(request).pipe(
