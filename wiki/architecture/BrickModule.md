...
sources:
  ...
  - path: apps/library/app/routes.ts
    ...
    lines: 27-56
  - path: apps/library/app/routes/modules/ModulePage.tsx
    sha: 49a411f8d6f581614b646d77dafd3f2fcfa2f157
    lines: 10-13
  - path: apps/library/app/routes/modules/ModuleDetail.tsx
    sha: 29312bdefd07b571d590de20fdfa941325e4d742
    lines: 32-43
  - path: apps/library/app/routes/bricks/BrickPage.tsx
...
3. Workbench navigation hits [`routes.ts`](../../apps/library/app/routes.ts) `modules`, `modules/:moduleId`, `modules/:moduleId/bricks/:brickId`, or `bricks/:moduleId`.
...
4. The module parent loader admits only registered `params.moduleId`.
   - [`routes.ts:21-52`](../../apps/library/app/routes.ts#L21-L52) — `path: "modules"` with nested `:moduleId` lazy `ModulePage` plus nested `ModuleDetail`. (`apps/library/app/routes.ts:21-52`)
   - [`ModulePage.tsx:10-13`](../../apps/library/app/routes/modules/ModulePage.tsx#L10-L13) — 404 when `params.moduleId` is missing or not in `modulesHash`. (`apps/library/app/routes/modules/ModulePage.tsx:10-13`)
5. A miss on that lookup is `undefined`.
   - [`ModulePage.tsx:12-12`](../../apps/library/app/routes/modules/ModulePage.tsx#L12) — `if (!modulesHash[params.moduleId])`. (`apps/library/app/routes/modules/ModulePage.tsx:12-12`)
6. The loader throws a 404 `Response`.
   - [`ModulePage.tsx:11-12`](../../apps/library/app/routes/modules/ModulePage.tsx#L11-L12) — `throw new Response("Not found", { status: 404 })`. (`apps/library/app/routes/modules/ModulePage.tsx:11-12`)
   - [`BrickPage.tsx:13-16`](../../apps/library/app/routes/bricks/BrickPage.tsx#L13-L16) — the same hash check on `bricks/:moduleId`. (`apps/library/app/routes/bricks/BrickPage.tsx:13-16`)
7. A hit means the loader returns `null` and the child route renders.
   - [`ModulePage.tsx:13-13`](../../apps/library/app/routes/modules/ModulePage.tsx#L13) — `return null` after the hash hit. (`apps/library/app/routes/modules/ModulePage.tsx:13-13`)
8. The module detail pane looks up the same key as `brickModule`.
   - [`ModuleDetail.tsx:31-34`](../../apps/library/app/routes/modules/ModuleDetail.tsx#L31-L34) — 404 without `params.moduleId`, then `brickModule = modulesHash[moduleId]`. (`apps/library/app/routes/modules/ModuleDetail.tsx:31-34`)
   - [`ModuleDetail.tsx:36-38`](../../apps/library/app/routes/modules/ModuleDetail.tsx#L36-L38) — pane 404 when the hash miss still happens after the loader. (`apps/library/app/routes/modules/ModuleDetail.tsx:36-38`)
   - [`BrickPage.tsx:19-23`](../../apps/library/app/routes/bricks/BrickPage.tsx#L19-L23) — standalone preview binds `brickModule = modulesHash[params.moduleId]`. (`apps/library/app/routes/bricks/BrickPage.tsx:19-23`)
...
9. The hash returns that `IModule`.
   - [`ModuleDetail.tsx:34`](../../apps/library/app/routes/modules/ModuleDetail.tsx#L34) — `const brickModule = modulesHash[moduleId]`. (`apps/library/app/routes/modules/ModuleDetail.tsx:34`)
10. Render uses `brickModule.component` as `Brick`.
    - [`ModuleDetail.tsx:41-42`](../../apps/library/app/routes/modules/ModuleDetail.tsx#L41-L42) — `const brick = brickModule` then `BrickComponent = brick.component`. (`apps/library/app/routes/modules/ModuleDetail.tsx:41-42`)
