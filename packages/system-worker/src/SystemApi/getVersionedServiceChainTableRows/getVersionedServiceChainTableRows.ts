...
/*
 * SystemApi exposes registered VersionedServiceChain tables to secret-key
...
export const getVersionedServiceChainTableRows = Effect.fn(
  'SystemApi.getVersionedServiceChainTableRows',
)(function* (props: {
  ...
  return yield* makeApiHandler({
    name: 'SystemApi.getVersionedServiceChainTableRows',
    ...
    handler: handlerProps =>
      Effect.gen(function* () {
        ...
        // 3 — query SystemRepo for VersionedServiceChain registrations
        ...
        if (
          ...
          return yield* new ZerospinError({
            ...
            message: `VersionedServiceChain "${repoName}" is not registered`,
            extra: {
              repoName,
              repoType: 'VersionedServiceChain',
            },
        ...
        const key =
          yield* VersionedServiceChain.fixedDORepoConfig.nameUtils.parseName(
            repoName,
          );
        const repo = yield* VersionedServiceChain.getRepo({
          key: {
            systemId: authResults.systemId,
        ...
        Effect.withSpan('SystemApi.getVersionedServiceChainTableRows', {
          root: true,
        }),
      ),
