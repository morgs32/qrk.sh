 ...
 */
export const getAuthenticatedVersionedAggregateRepos = Effect.fn(
  'SystemApi.getAuthenticatedVersionedAggregateRepos',
)(function* (props: {
  request: Parameters<SystemApi['getAuthenticatedVersionedAggregateRepos']>[0];
  ...
  return yield* makeApiHandler({
    name: 'SystemApi.getAuthenticatedVersionedAggregateRepos',
    ...
    handler: () =>
      Effect.gen(function* () {
        ...
        // 5 — decode SystemRepo.getRepoRegistrations for AuthenticatedVersionedAggregateRepo
        ...
        Effect.withSpan('SystemApi.getAuthenticatedVersionedAggregateRepos', {
          root: true,
        }),
      ),
  })(request).pipe(
