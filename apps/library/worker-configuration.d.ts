/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./worker-configuration.d.ts` (hash: 6f08cf911127901aa1131898aae3c515)
...
interface __BaseEnv_Env {
	...
	INSTAGRAM_BACKEND: DurableObjectNamespace<import("./worker/Worker").InstagramBackend>;
	GITHUB_BACKEND: DurableObjectNamespace<import("./worker/Worker").GitHubBackend>;
	FIGMA_BACKEND: DurableObjectNamespace<import("./worker/Worker").FigmaBackend>;
	GOOGLE_PLACES_BACKEND: DurableObjectNamespace<import("./worker/Worker").GooglePlacesBackend>;
	LINK_BACKEND: DurableObjectNamespace<import("./worker/Worker").LinkBackend>;
	STREAMLINE_BACKEND: DurableObjectNamespace<import("./worker/Worker").StreamlineBackend>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/Worker");
		durableNamespaces: "BrowserHost" | "StreamlineBackend" | "InstagramBackend" | "GitHubBackend" | "FigmaBackend" | "GooglePlacesBackend" | "LinkBackend";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "R2_PUBLIC_BASE_URL" | "PUBLIC_MAPBOX_TOKEN" | "GITHUB_TOKEN" | "STREAMLINE_API_KEY" | "GET_ILLUSTRATIONS_API_KEY" | "FIGMA_TOKEN" | "GOOGLE_PLACES_API_KEY">> {}
}
