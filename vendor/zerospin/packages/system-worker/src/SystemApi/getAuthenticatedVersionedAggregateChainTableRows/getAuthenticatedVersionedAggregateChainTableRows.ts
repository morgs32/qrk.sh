 ...
 */
export const getAuthenticatedVersionedAggregateChainTableRows = Effect.fn(
  ...
  return yield* makeApiHandler({
    name: 'SystemApi.getAuthenticatedVersionedAggregateChainTableRows',
    ...
    handler: handlerProps =>
      Effect.gen(function* () {
        ...
        // 3 — query SystemRepo for AuthenticatedVersionedAggregateChain registrations
        ...
        if (
          ...
          return yield* new ZerospinError({
            ...
            message: `AuthenticatedVersionedAggregateChain "${repoName}" is not registered`,
            extra: {
              repoName,
              repoType: 'AuthenticatedVersionedAggregateChain',
            },
        ...
        const repo = yield* AuthenticatedVersionedAggregateChain.getRepo({
          key: {
            systemId: authResults.systemId,
